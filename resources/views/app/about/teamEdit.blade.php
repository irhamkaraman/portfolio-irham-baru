                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('team.update', $team->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="text-center mb-3">
                                        <img src="{{ asset('storage/teams/' . $team->avatar) }}" alt="{{ $team->name }}" class="" width="100" style="object-fit: cover;" />
                                    </div>
                                    @endif
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                        <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" rows="5"> {{ $team->description }} </textarea>
                                    </div>
