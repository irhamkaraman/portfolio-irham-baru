                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('portfolio.update', $portfolio->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 text-center">
                                        <img src="{{ asset('storage/portfolio/' . $portfolio->image) }}" alt="{{ $portfolio->name }}" class="" width="100" style="object-fit: cover;" />
                                    </div>
                                    @endif
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ $portfolio->title }}" />
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                        <input type="text" class="form-control @error('url') is-invalid @enderror" id="url" name="url" value="{{ $portfolio->url }}" />
                                    </div>
