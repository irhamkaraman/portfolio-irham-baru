                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('education.update', $education->id) }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @enderror
                                        <input type="text" class="form-control @error('school') is-invalid @enderror" id="school" name="school" value="{{ $education->school }}" />
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                        <input type="number" class="form-control @error('start_date') is-invalid @enderror" id="start_date" name="start_date" value="{{ $education->start_date }}" />
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                        <input type="number" class="form-control @error('end_date') is-invalid @enderror" id="end_date" name="end_date" value="{{ $education->end_date }}" />
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                        <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" rows="5">{{ $education->description }}</textarea>
                                    </div>
