                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('experience.store') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @enderror
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" placeholder="Masukkan Pengalaman" />
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                        <input type="number" class="form-control @error('start_date') is-invalid @enderror" id="start_date" name="start_date" placeholder="Masukkan Tahun Awal Pengalaman" />
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                        <input type="number" class="form-control @error('end_date') is-invalid @enderror" id="end_date" name="end_date" placeholder="Masukkan Tahun Akhir Pengalaman" />
                                    </div>
