                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('skills.update', $skills->id) }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @enderror
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ $skills->title }}" />
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="range" class="form-range" id="range" name="range" min="1" max="100" step="1" value="{{ $skills->range }}" oninput="this.nextElementSibling.innerText=this.value+'%'">
                                        <span class="d-inline-block align-middle">{{ $skills->range }}%</span>
                                    </div>
